    ...
    if (this.state.diamond.lotID === "" || this.state.diamond.shape === "" || this.state.diamond.weight === "" || this.state.diamond.color === "" || this.state.diamond.clarity === "" || this.state.page === 0) {
        parse.push(
            ...
            <Modal.Body>Lot ID
                ...
                <Image onClick={this.detectMouse} style={{ width: "100%" }} src="https://lh3.googleusercontent.com/npQZhrsBBjxOQg42ha48hNxbJpVrIWXkmYq36MnglUwfoCGtMXn7fT10vKId6W10SmL1qL5_9tyTRs9Kswt88KxhPk9pAiQOC4OmJfekmCp0nG8tH5nmX_X9-3jVBGGubi8sXmPGt6yIqv5y2uKy9z6YHppeWDY-nxrWkELM-DMahV0sPVsT8PIULu8FVZBwYizqN2NCGyU9kbGLXhyoEy_rLuPHxvKdl76Deu0RtcBhn_VL5uljUZJfTgywGFW_jFtEQCw2Kc2ee-TY1A4Qcl6IWZm7eMxR56LH4tI1i5JMSb0gR8DqdKhwgCfElfK2jD3jhTPuAtrbeSPxwi1nS4mB4QQ28LePxUAyKe7N1TTrmSElWqmTE_l5aftqfWNgfzfDiFYqeR0UU-OsMZ3JgQwCWeTbzXvlZPpPgW74Az8O-aJRpvtUZpnNjJ_iuSVuvBWGL47nEy0chonexAEZwbpuLjrUMQELiuWu-_i-3gjndVZJRLpGJKOcRQFkXcDUXWiZJlRDjsoqaOjmcYLDS-soQ9nL95XSFUlevx9ZqIvX5khC3mGTuHS9wZjiledwda8NrgJAQI-wWkpd1roHsrksNBZHXGDI2_qtbUJv7mWs32S1b8IsJHhCimyBr3eMYF2-HOrVPI1uzDizoldb3ccbHPCcWs48lML8gVmMmKi52PvZFIdvsp8F=w1913-h318-no" rounded />
